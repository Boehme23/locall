...
const TOURIST_SPOTS = [
  ...
  { id: 'mirante', name: 'Mirante', description: 'Vista panorâmica da cidade de Lages.' },
  { id: 'parque-europa', name: 'Parque Europa', description: 'Parque urbano com lagos e trilhas.' },
...
const COUPONS = [
  ...
  { id: 'cupom3', spotId: 'parque-europa', store: 'Restaurante Europa', description: 'Sobremesa grátis no almoço.' },
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <footer className="text-center text-xs text-gray-500 py-4">&copy; {new Date().getFullYear()} TourCupom Lages</footer>
    </div>
  );
}
